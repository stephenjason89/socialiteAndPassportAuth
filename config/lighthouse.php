...
return [
    ...
    */
    ...
    'namespaces' => [
        'models' => array_merge(['App', 'App\\Models'], getFolders("Modules", "\\Entities")),
        'queries' => array_merge(['App\\GraphQL\\Queries'], getFolders("App\\GraphQL\\Queries")),
        'mutations' => array_merge(['App\\GraphQL\\Mutations'], getFolders("App\\GraphQL\\Mutations")),
